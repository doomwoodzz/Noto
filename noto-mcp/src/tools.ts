import type { NotoClient } from "./notoClient.js";
...
/**
 * Build the 9 tool handlers. `scope` is the auto-detected project key; read tools
 * (search/recall) default to it; write tools are path-addressed and ignore it.
 */
